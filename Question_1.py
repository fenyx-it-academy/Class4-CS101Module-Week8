...
top_10_of_GS=LinkedList()
print(top_10_of_GS)

top_10_of_GS.add("Gheorghe_HAGI")
top_10_of_GS.add("Cassio_LINCOLN")
top_10_of_GS.add("Wesley_SNEIJDER")
top_10_of_GS.add("Younes_BELHANDA")
print(top_10_of_GS)

top_10_of_GS.remove_first()
print(top_10_of_GS)
top_10_of_GS.remove_first()
print(top_10_of_GS)
top_10_of_GS.remove_first()
