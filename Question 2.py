...
(Hint: Enqueuing happens at the tail of the list, and the dequeuing of items happens at the head of the list.)
"""
### singlelinkedlist ###
...
abc.enqueue(600)
while abc.size() > 0:
    print("First item Removed \t :", abc.dequeue())
    print("New First item \t\t :", abc.peek())
    print("Size \t\t\t\t :", abc.size())
    abc.is_empty()
